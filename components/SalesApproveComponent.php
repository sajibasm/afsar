...
class SalesApproveComponent extends Component
{
    ...
    /**
     * Process payment history and payment details creation or update.
     *
     * @param Sales $model
     * @param string $type
     * @throws Exception
    ...
    private function updateDetailsAndStatements(Sales $model)
    {
        ...
        $statementUpdated = Yii::$app->db->createCommand()
            ->update(ProductStatementOutlet::tableName(), ['remarks' => 'Approved'], ['reference_id' => $model->sales_id])
            ->execute();
    ...
    /**
     * Handle client financial updates after sales approval (create or update).
     *
     * @param Sales $model
     * @param Sales $oldSales
    ...
    private function saveSales(Sales $model, $type, Sales $oldSales): array
    {
        ...
        try {
            ...
            return ['success' => true, 'message' => 'Sales saved and updated successfully.'];
